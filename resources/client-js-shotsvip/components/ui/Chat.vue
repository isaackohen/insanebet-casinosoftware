    ...
    <div :class="'chat ' + (chat ? 'visible' : 'hidden')">
        <div class="fixed">
            ...
            <div class="topWinners">
                <div class="header">
                    <div class="ribbon">
                        <div class="ribbon-content"><p class="ribbon-content-text"><b>{{ $t('general.biggest_winner_today') }}</b></p></div>
                    </div>
                </div>
                <div class="winners">
            ...
            .topWinners {
                ...
                .header {
                    ...
                    .ribbon:before, .ribbon:after {
                        ...
                        display: block;
                        bottom: -1em;
                        border: 1.5em solid darken(t('ribbon-bg-base'), 2%);
                        z-index: -1;
                    }
                    ...
                    .ribbon .ribbon-content:before, .ribbon .ribbon-content:after {
                        border-color: darken(t('ribbon-bg-base'), 3%) transparent transparent transparent;
                        position: absolute;
                        display: block;
                        border-style: solid;
                        bottom: -1em;
