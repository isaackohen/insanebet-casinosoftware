    ...
    <div>
        ...
        <div class="mobile-menu-games" v-if="gamesWindow" @click="gamesWindow = false">
            <div class="mobile-menu-games-container os-host-flexbox">
				...
				<router-link to="/challenges" class="game" @click.native="gamesWindow = false">
                    <div class="icon"><i class="fas fa-bullseye-arrow"></i></div>
                    <div class="name letter-spacing">{{ $t('general.sidebar.challenges') }}</div>
                </router-link> 
				
				<router-link v-if="currencies.bonusBattle === 'true'" to="/bonusbattle" class="game" @click.native="gamesWindow = false">
                    <div class="icon"><i class="fas fa-swords"></i></div>
                    <div class="name letter-spacing">{{ $t('general.sidebar.bonusbattle') }}</div>
                </router-link> 
