                                    ...
                                    <table class="live-table">
                                        ...
                                        <tbody class="live_games">
                                            <tr v-for="(entry, i) in leaderboard" :class="i === 0 ? 'first' : (i === 1 ? 'second' : (i === 2 ? 'third' : ''))">
                                                ...
                                                <th>
                                                    <div>
                                                        {{ usd ? ('$ ' + (entry.entry.wager * currencies[currencySelected.id].price).toFixed(2)) : (entry.entry.wager.toFixed(currencySelected.id.startsWith('local_') ? 2 : 8)) }}
                                                    </div>
                                                </th>
                                                <th>
                                                    <div>
                                                        {{ usd ? ('$ ' + (entry.entry.profit * currencies[currencySelected.id].price).toFixed(2)) : (entry.entry.profit.toFixed(currencySelected.id.startsWith('local_') ? 2 : 8)) }}
                                                    </div>
                                                </th>
                                            </tr>
                                        </tbody>
