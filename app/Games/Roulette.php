...
class Roulette extends QuickGame implements MultiplierCanBeLimited
{
    ...
    public function start($user, Data $data)
    {
        ...
        if ($totalBet < floatval(Settings::get('min_bet') / Currency::find($data->currency())->tokenPrice()) || ($user != null && $user->balance(Currency::find($data->currency()))->demo($data->demo())->get() < $totalBet)) {
