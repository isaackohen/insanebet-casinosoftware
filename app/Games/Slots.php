...
class Slots extends QuickGame implements MultiplierCanBeLimited
{
    ...
    private function convertToView($result)
    {
        ...
        foreach ($result as $item) {
            ...
            foreach ($item as $value) {
                array_push($column, array_search($value, $this->icons));
            }
    ...
    public function getProfit($lines, $totalBet, $singleLineBet, array $view): array
    {
        return [
